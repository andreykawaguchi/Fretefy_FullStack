    ...
    public class RegiaoController : ControllerBase
    {
        ...
        public IActionResult Put(Guid id, [FromBody] UpdateRegiaoDto regiaoDto)
        {
            ...
            try
            {
                ...
                if (updated == null)
                {
                    return NotFound(new { message = "Regi�o n�o encontrada." });
                }
            ...
            {
                return Conflict(new { message = "A regi�o foi modificada por outro usu�rio. Tente novamente.", details = ex.Message });
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Ativar(Guid id)
        {
            try
            {
                ...
                return Ok(new { message = "Regi�o ativada com sucesso." });
            }
            catch (DomainException ex)
            {
                return BadRequest(new { message = ex.Message });
        ...
        public IActionResult Desativar(Guid id)
        {
            try
            {
                ...
                return Ok(new { message = "Regi�o desativada com sucesso." });
            }
            catch (DomainException ex)
            {
                return BadRequest(new { message = ex.Message });
